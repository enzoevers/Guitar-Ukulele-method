...
In Hedwig's Theme (see the \hyperlink{UkuleleHarrysPotterHedwigsTheme.pdf.1}{next page}) you will see the usage of sharps, flats, naturals and music-wide sharps.
...
The following song introduces two new high notes. The E and F (see \ref{fig:ukulele_high_e_f_notes}). Note that in \autoref{fig:ukulele_cest_la_vie_chefspecial} all F notes become an F\sharp due to the sharps at the start of the song.
...
The notes here play the singing/melodie line. Therefore the chords are placed above the notes to make it easier for two people two play together. One plays the chords, the other the melody. But don't worry about the chords yet. We come to that in the next chapter.
