...
The minor diatonic scale has the formula shown in \autoref{tab:ukulele_minor_scale_interval}.
...
\begin{table}[h]
	...
	\label{tab:ukulele_minor_scale_interval}
\end{table}
...
\begin{table}[h]
	...
	\label{tab:ukulele_a_minor_scale}
\end{table}

Similar to example for the major scales of the natural notes, \autoref{tab:ukulele_natural_note_minor_scale} shows the minor scales of the natural notes.
...
\begin{table}[h]
	...
	\label{tab:ukulele_natural_note_minor_scale}
\end{table}

\newpage

Just as for the major scale, there are also patterns for the minor scale

\begin{figure}[h]
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{../../Images/ukulele_minor_scale_three_string.png}
		\caption{Minor scale on the fretboard on three strings}
		\label{fig:ukulele_minor_scale_fretboard_compact}
	\end{subfigure}
	\hfill
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=\textwidth]{../../Images/ukulele_minor_scale_single_string.png}
		\caption{Minor scale on the fretboard on a single string}
		\label{fig:ukulele_minor_scale_fretboard_single_string}
	\end{subfigure}
	
	\vspace{0.5cm}
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[width=\textwidth]{../../Images/ukulele_minor_scale_double_string_from_c.png}
		\caption{Minor scale on the fretboard on two strings starting from the C string}
		\label{fig:ukulele_minor_scale_fretboard_double_string_from_c}
	\end{subfigure}
	
	\caption{Minor scale on the fretboard}
	\label{fig:ukulele_minor_scale_fretboard}
\end{figure}

\newpage

Of course, you don't have to start on the C string. you can also start on the E string. Then the two-string shape would look like \autoref{fig:ukulele_minor_scale_fretboard_double_string_from_e}. Here we are playing an F major scale.

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{../../Images/ukulele_minor_scale_double_string_from_e.png}
	\caption{Minor scale on the fretboard on two strings starting from the E string}
	\label{fig:ukulele_minor_scale_fretboard_double_string_from_e}
\end{figure}

Now that we've seen a lot of different ways to play the minor scale, we will start focusing on the most compact shape. The shape shown in \autoref{fig:ukulele_minor_scale_fretboard_compact}.

\subsubsection{Exercise}

In \autoref{chap:empty_ukulele_fretboard} you see some empty ukulele fretboards. Try to fill these with the different minor scales (A, B, C, D, E, F, G) that we've seen in \autoref{tab:ukulele_natural_note_minor_scale}. Write the note names instead of the numbers 1-8. Use the shape from \autoref{fig:ukulele_minor_scale_fretboard_compact}. You can of course print out the empty ukulele fretboard diagram as often as you want.
