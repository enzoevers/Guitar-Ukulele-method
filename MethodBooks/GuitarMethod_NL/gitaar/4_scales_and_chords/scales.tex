...
\subsubsection{Een gevoel krijgen voor de majeur toonladder}

Een manier om een goed gevoel te krijgen voor hoe de majeur toonladder zou 'voelen', is om een 'drone' noot te spelen en dan noten uit de majeur toonladder daar overheen te spelen op een enkele snaar. Neem bijvoorbeeld de E majeur toonladder (\autoref{fig:major_scale_with_drone_single_string}). Speel de open lage E snaar, en speel een melodie op de 4e snaar met de majeur toonladder. Je zult horen hoe de verschillende intervallen verschillende relaties tot de grondtoon (E) hebben.

\begin{figure}[h]
	\centering
	\includegraphics[height=0.18\textheight]{../../Images/major_scale_drone_single_string.png}
	\caption{E majeur op een enkele snaar met een open E snaar drone}
...
\subsubsection{Een gevoel krijgen voor de mineur toonladder}

Een manier om een goed gevoel te krijgen voor hoe de mineur toonladder zou 'voelen', is om een 'drone' noot te spelen en dan noten uit de mineur toonladder daar overheen te spelen op een enkele snaar. Neem bijvoorbeeld de E mineur toonladder (\autoref{fig:minor_scale_with_drone_single_string}). Speel de open lage E snaar, en speel een melodie op de 4e snaar met de majeur toonladder. Je zult horen hoe de verschillende intervallen verschillende relaties tot de grondtoon (E) hebben.

\begin{figure}[h]
	\centering
	\includegraphics[height=0.18\textheight]{../../Images/minor_scale_drone_single_string.png}
	\caption{E mineur op een enkele snaar met een open E snaar drone}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{\textwidth}
		...
		\caption{De majeur en mineur toonladder vormen koppelen in de mineur context}
...
\section{Een metronoom gebruiken (handen synchroniseren)}
