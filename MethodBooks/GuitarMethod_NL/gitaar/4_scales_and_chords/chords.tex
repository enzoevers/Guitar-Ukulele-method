...
\subsection{Akkoordintervallen op het fretbord}

\autoref{fig:guitar_major_triad_intervals} toont de majeur intervallen van een grondtoon beginnend op de 6e en 5e snaar, en gebruikt 3 frets aan elke kant van deze grondtoon. De fretnummers zijn bewust weggelaten. Dit komt omdat deze intervallen niet gebonden zijn aan één enkele positie.

\infobox{Let op: deze diagrammen tonen de intervallen in de toonladder. Het zijn niet de halftonen van het interval die je omhoog of omlaag telt. Voor noten boven de grondtoon zijn dit hetzelfde. Maar niet voor noten 'onder' de grondtoon.
	
Bijvoorbeeld: De reine kwint is 7 halftonen. Als je 7 halftonen 'omlaag' zou tellen vanaf de grondtoon, krijg je niet de reine kwint, maar de reine kwart (12 - 7 = 5 halftonen $\rightarrow$ reine kwart). In plaats daarvan wordt de reine kwint boven de grondtoon genomen en een octaaf verlaagd.}

\begin{figure}[h]
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{../../Images/MajorTriadIntervalsStartingFromString5.png}
		\caption{Majeur drieklank intervallen vanaf de 5e snaar}
		\label{fig:guitar_major_triad_intervals_from_string_5}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\textwidth]{../../Images/MajorTriadIntervalsStartingFromString6.png}
		\caption{Majeur drieklank intervallen vanaf de 6e snaar}
		\label{fig:guitar_major_triad_intervals_from_string_6}
	\end{subfigure}
	\caption{Majeur drieklank intervallen. Om de mineur drieklank intervallen te krijgen, verplaats de 3 één fret naar links.}
	\label{fig:guitar_major_triad_intervals}
\end{figure}

Als je kijkt naar \autoref{fig:guitar_major_triad_intervals} en vervolgens naar de diagrammen die de standaard akkoordvormen tonen in \autoref{fig:guitar_major_minor_chords}, herken je misschien hoe deze standaardvormen gevormd worden uit de majeur drieklank.
