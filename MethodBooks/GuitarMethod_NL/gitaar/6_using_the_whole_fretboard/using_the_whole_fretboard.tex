...
Je hebt ook geleerd over de relatieve mineur- en majeurtoonladders bij de kwintencirkel. In \autoref{tab:guitar_mode_intervals} zie je dat als je begint op de 6e graad van de majeurtoonladder (Ionische modus), je de intervallen van de natuurlijke mineurtoonladder krijgt (\textnormal{A}eolische), terwijl je nog steeds dezelfde noten hebt.

Betekent dit dat je kunt improviseren met de A-mineur toonladder over een nummer in C-majeur? JA! Het zijn dezelfde noten. Betekent dit dat C-majeur en A-mineur hetzelfde zijn? \textbf{NEE!} Dat betekent ook dat je alleen kunt zeggen dat een nummer in C-majeur, A-mineur, E-frygisch, enz. staat door te kijken naar het \mbox{\textbf{tonale centrum}} (de toon die het meest prominent is) van de muzikale context. Let op dat de intervallen vanaf de grondtoon van elke modus verschillend zijn.

\underline{Ezelsbruggetje voor de volgorde van de modale namen: \textbf{I} \textbf{D}on't \textbf{P}articularly \textbf{L}ike \textbf{M}odes \textbf{A} \textbf{Lo}t.} % TODO: Nederlandse versie
...
Als je nu een akkoordprogressie maakt voor een modus, is het goed om ten minste één akkoord uit \autoref{tab:guitar_mode_characteristic_chords} te gebruiken, naast het eerste akkoord van de modus. Het verschil horen tussen modi is over het algemeen lastiger dan het verschil horen tussen majeur en mineur.

Daarom, \textbf{hou het simpel}. Modale akkoordprogressies moeten de karakteristieke note(n) benadrukken. De akkoorden hoeven ook niet perse terug naar de grondtoon te gaan. De karakteristieke noten gebruiken in de melodie die je over de akkoorden speelt helpt ook.

Een oefening om beter te horen welk 'gevoel' de verschillende modi geven, kan je het volgende doen. Speel een open 'drone' noot en ga dan op een enkele snaar de noten/intervallen uit een mode spelen van de grondtoon. In \autoref{fig:guitar_diatonic_modes_on_guitar_with_drone_note_single_string} is de open lage E snaar de drone noot. Op de vierde snaar zie je de mode intervallen van de respectievelijke E modi.

\newpage

\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{../../Images/guitar_mode_all_interval_drone_single_string.png}
	\caption{Modi op een enkele snaar met een drone noot}
	\label{fig:guitar_diatonic_modes_on_guitar_with_drone_note_single_string}
\end{figure}
...
\autoref{fig:guitar_mode_scale_shapes} en \autoref{fig:guitar_diatonic_modes_on_guitar} tonen de verschillende mode-vormen. In \autoref{fig:guitar_diatonic_modes_on_guitar} beginnen we met de F$\sharp$ Ionische (majeur) toonladder. Maar onthoud dat deze omhoog of omlaag kunnen worden verschoven om in een andere toonsoort te spelen.
...
\begin{figure}[h]
	\begin{subfigure}[b]{0.31\textwidth}
		\centering
		\includegraphics[height=0.165\textheight]{../../Images/IonianScaleShape.png}
		\caption{Ionisch}
	...
	\begin{subfigure}[b]{0.31\textwidth}
		\centering
		\includegraphics[height=0.165\textheight]{../../Images/DorianScaleShape.png}
		\caption{Dorisch}
	...
	\begin{subfigure}[b]{0.31\textwidth}
		\centering
		\includegraphics[height=0.165\textheight]{../../Images/PhrygianScaleShape.png}
		\caption{Frygisch}
	...
	\begin{subfigure}[b]{0.31\textwidth}
		\centering
		\includegraphics[height=0.165\textheight]{../../Images/LydianScaleShape.png}
		\caption{Lydisch}
	...
	\begin{subfigure}[b]{0.31\textwidth}
		\centering
		\includegraphics[height=0.165\textheight]{../../Images/MixolydianScaleShape.png}
		\caption{Mixolydisch}
	...
	\begin{subfigure}[b]{0.31\textwidth}
		\centering
		\includegraphics[height=0.165\textheight]{../../Images/AeolianScaleShape.png}
	...
	\begin{subfigure}[b]{0.31\textwidth}
		\centering
		\includegraphics[height=0.165\textheight]{../../Images/LocrianScaleShape.png}
		\caption{Locrisch}
