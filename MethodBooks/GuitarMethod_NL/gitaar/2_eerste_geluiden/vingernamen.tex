...
Het volgende nummer (\autoref{fig:guitar_smoke_on_the_water_into}) is een bekende riff om een keer te spelen.

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{../../MuseScore/Guitar/SmokeOnTheWaterIntro.png}
	\caption{Smoke On The Water - Deep Purple intro}
	\label{fig:guitar_smoke_on_the_water_into}
\end{figure}


\newpage

Om alvast wat gevoel voor akkoorden te krijgen gaan we "Fly Away" van "Lenny Kravitz" spelen. De noten die je ziet in \autoref{fig:guitar_core_chords_fly_away_lenny_kravitz} zijn de rode draad van het nummer.

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{../../MuseScore/Guitar/FlyAway_LennyKravitz_RhythmGuitar.png}
	\caption{De rode draad van "Fly Away - Lenny Kravitz"}
	\label{fig:guitar_core_chords_fly_away_lenny_kravitz}
\end{figure}