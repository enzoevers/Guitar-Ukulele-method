...
In \ref{fig:tetris_simple_first_part} the first part of the Tetris tune is written. Note the dotted note in measure 3. The full tune requires to learn about sharps and flats. So we will play the full tune later.
