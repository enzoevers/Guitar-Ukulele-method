...
The next song (\autoref{fig:guitar_smoke_on_the_water_into}) is a classic first riff to play.
...
To already get a first feel for chords, lets try "Fly Away" from "Lenny Kravitz". The notes shown in \autoref{fig:guitar_core_chords_fly_away_lenny_kravitz} are the main chords of the songs.

\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{../../MuseScore/Guitar/FlyAway_LennyKravitz_RhythmGuitar.png}
	\caption{Core chords of "Fly Away - Lenny Kravitz"}
