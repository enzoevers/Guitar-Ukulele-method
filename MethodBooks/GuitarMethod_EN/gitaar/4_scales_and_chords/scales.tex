...
\infobox{Note how, when you go from the lowest to the highest string (except for G to B), each pair of strings has a \textbf{perfect 4th} internal. The interval between the G and B strings is a \textbf{major 3rd}.}
...
\subsubsection{Getting a feeling for the major scale}

Another way to get a good feeling for what the major scale would 'feel' is to play the root of the major scale as a drone note and then playing the notes from the major scale on a single string over it. Taking the E major scale as an example (\autoref{fig:major_scale_with_drone_single_string}). Play the open low E string and play a melody on the 4th string using the major scale. You will hear which interval gives what type of relation to the root.

\begin{figure}[h]
	\centering
	\includegraphics[height=0.18\textheight]{../../Images/major_scale_drone_single_string.png}
	\caption{E major on a single string with an open E string drone}
	\label{fig:major_scale_with_drone_single_string}
\end{figure}
...
\subsection{The minor scale} \label{sec:minor_scale}
...
\subsubsection{Getting a feeling for the minor scale}

Another way to get a good feeling for what the minor scale would 'feel' is to play the root of the minor scale as a drone note and then playing the notes from the minor scale on a single string over it. Taking the E minor scale as an example (\autoref{fig:minor_scale_with_drone_single_string}). Play the open low E string and play a melody on the 4th string using the minor scale. You will hear which interval gives what type of relation to the root.

\begin{figure}[h]
	\centering
	\includegraphics[height=0.18\textheight]{../../Images/minor_scale_drone_single_string.png}
	\caption{E minor on a single string with an open E string drone}
	\label{fig:minor_scale_with_drone_single_string}
\end{figure}
...
\subsection{Using major and minor 'shapes' in different contexts}

To drive home the thing about shapes just being shapes, have a look at \autoref{fig:guitar_major_minor_scale_connection_fretboard}. Both diagram show the exact same notes. But the meaning of that note differs per context. Note how there are overlapping notes between the major and minor scale shapes.

\begin{figure}[h]
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[height=0.2\textheight]{../../Images/major_scale_using_major_minor_shape.png}
		\caption{Connecting the major and minor scale shapes in the major context}
		\label{fig:connecting_major_minor_shapes_major_context}
	\end{subfigure}
	...
	\begin{subfigure}[b]{\textwidth}
		\centering
		\includegraphics[height=0.2\textheight]{../../Images/minor_scale_using_major_minor_shape.png}
		\caption{Connecting the major and minor scale shapes in the minor context}
		\label{fig:connecting_major_minor_shapes_minor_context}
	\end{subfigure}
	
	\caption{Connecting the major and minor scales for different contexts}
	\label{fig:guitar_major_minor_scale_connection_fretboard}
\end{figure}
