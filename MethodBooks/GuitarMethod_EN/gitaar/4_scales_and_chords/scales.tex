...
\begin{itemize}
	\item Write the diatonic major (w-w-h-w-w-w-h) and major (w-h-w-w-h-w-w) scales formulas on paper, and then write the scale of each note (A to G) by going through the whole and half steps.
...
It might take some time to really internalize this, and it may be boring, but it's worth it in the long term.
