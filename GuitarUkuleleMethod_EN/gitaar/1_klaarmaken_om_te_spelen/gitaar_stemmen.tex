...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{image/guitar-neck-string-names.png}
...
\begin{minipage}{0.7\textwidth}
    \infobox{Note that things is the standard tuning. Sometimes the guitar will be tuned differently. But that will then be explicitely mentioned}
\end{minipage}
